...
def register(app):
    ...
    def cb_economics(yr_range, regions, season):
        ...
        from api.cache import get_lcoe_df, is_ready
        ...
        # ── LCOE range bar: current year bands ───────────────────────────────
        ...
        # ── Spot price vs LCOE ────────────────────────────────────────────────
        p = filter_prices(regions or NEM_REGIONS, yr_range)
        fig3 = go.Figure()
